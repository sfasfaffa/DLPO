...
class StringBasedFunction_v2(Function):
    ...
    def _backward_through_string_fn_chain(variables: List[Variable],
        ...
        for variable in variables:
            ...
            backward_prompt = StringBasedFunction_v2._construct_string_fn_chain_backward_prompt(backward_info)
    ...
    def _backward_through_string_fn_base(variables: List[Variable],
        ...
        for variable in variables:
            ...
            backward_prompt = StringBasedFunction_v2._construct_string_fn_base_backward_prompt(backward_info)
